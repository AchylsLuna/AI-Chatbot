...
type DoctorNotificationsSectionProps = {
...
const DoctorNotificationsSection = ({ items, dataMaskingEnabled }: DoctorNotificationsSectionProps) => {
  return (
...
export default DoctorNotificationsSection
