...
const WorkspaceSidebar = ({
  ...
  <aside
    className={`${className ?? ''} relative overflow-hidden rounded-[30px] border border-[rgba(106,123,179,0.28)] bg-[linear-gradient(180deg,rgba(20,23,44,0.97),rgba(14,18,36,0.96))] shadow-[0_30px_70px_rgba(0,0,0,0.45)]`}
  >
