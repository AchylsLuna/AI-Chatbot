    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-1">Patient Digital Twin</h2>
            <p className="text-gray-500">360-degree view of medical history</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="flex flex-col items-center mb-6 pb-6 border-b">
              ...
              <p className="text-sm text-gray-500">Patient ID: P-2847</p>
            </div>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">March 15, 1985 (40y)</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">San Francisco, CA</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">sarah.j@email.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 border-t">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="font-bold text-gray-900">AI Health Summary</h4>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Interactive Body Map</h3>
            <p className="text-sm text-gray-500 mb-8">Click on body parts to view medical history</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="text-lg font-bold text-gray-900">Smart Contract Access</h3>
            </div>
            <p className="text-sm text-gray-500 mb-6">Control who can access your medical records via blockchain smart contracts</p>
            ...
            <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                      doctorAccess.drChen ? 'bg-blue-600' : 'bg-gray-300'
                    }`}
                  >
                    <span
              ...
              <div className="flex items-center justify-between pb-4 border-b">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                      doctorAccess.drRodriguez ? 'bg-blue-600' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition ${
              ...
              <div className="flex items-center justify-between pb-4 border-b">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                      doctorAccess.drWatson ? 'bg-blue-600' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition ${
              ...
              <div className="flex items-center justify-between pb-4 border-b">
                <div>
                  <p className="font-semibold text-gray-900">Dr. James Park</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition ${
                      doctorAccess.drPark ? 'bg-blue-600' : 'bg-gray-300'
                    }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition ${
            ...
            {/* Recent Access Log */}
            <div>
              <h4 className="font-semibold text-gray-900 mb-4">Recent Access Log</h4>
              <div className="space-y-3">
                <div className="text-sm">
                  <p className="font-semibold text-gray-900">Dr. Sarah Chen</p>
                  <p className="text-gray-600">Viewed ECG Results • 2h ago</p>
                </div>
                <div className="text-sm">
                  <p className="font-semibold text-gray-900">Dr. James Park</p>
                  <p className="text-gray-600">Updated Medication • 5h ago</p>
                </div>
                <div className="text-sm">
                  <p className="font-semibold text-gray-900">Dr. Michael Rodriguez</p>
                  <p className="text-gray-600">Reviewed X-Rays • 1d ago</p>
                </div>
              </div>
            </div>
          </div>
